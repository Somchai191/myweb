...
export default function About({ isScrolled }) {
  return (
    <div className="flex flex-col sm:flex-row bg-white p-6 rounded-lg shadow-lg h-full w-full">
      {/* รูปภาพด้านซ้าย */}
      <div
        className={`w-[240px] h-[240px] sm:w-[500px] sm:h-[500px] flex-shrink-0 overflow-hidden shadow-md border-2 border-gray-300 transform transition-transform duration-[700ms] ease-out ${
      ...
      {/* ข้อความ */}
      <div className="sm:ml-6 mt-2 sm:mt-20 text-center sm:text-left flex-1">
